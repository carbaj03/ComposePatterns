...
data class ActivateTodo(val activatedId: Int) : TodoListAction()
data class ActivateTodoSuccess(val todos: List<Todo>) : TodoListAction()
object ActivateTodoError : TodoListAction()
